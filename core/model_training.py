...
def build_dataset(dataset, shape):
...
def get_conv_lstm_model_architecture(train, batch_size, nb_epoch, neurons, is_stateful=False, # todo
...
def fit_conv_lstm(train, batch_size, nb_epoch, neurons, is_stateful=False, # todo
